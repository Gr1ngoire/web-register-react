...
class SignUpValidator {
    ...
    private VALIDATORS = new Map<string, Validator>([['name', new NameValidator()], ['surname', new SurnameValidator()], ['phoneNumber', new PhoneNumberValidator()], ['email', new EmailValidator()], ['secondName', new SecondNameValidator()], ['password', new PasswordValidator()], ['group', new GroupValidator()], ['gender', new GenderValidator()]]);
